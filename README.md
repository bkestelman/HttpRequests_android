...
// Choose a Callback implementation. The Callback interface contains a callback() method, which is called once you
// receive a response from the server. You can use one of the preset Callback implementations here, or implement the 
// Callback interface and override callback() to make your own. 
